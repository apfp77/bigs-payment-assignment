...
data class PaymentResponse(
    ...
    @get:Schema(description = "적용된 수수료율", example = "0.0235")
    val appliedFeeRate: BigDecimal,

    @get:Schema(description = "수수료 금액", example = "235")
    ...
    @get:Schema(description = "PG 승인 코드", example = "10080728")
    val approvalCode: String,

    @get:Schema(description = "PG 승인 시각", example = "2025-01-27 10:00:00")
