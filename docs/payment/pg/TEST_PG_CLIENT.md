...
| 필드           | 규칙                  | 에러 메시지                                      |
| -------------- | --------------------- | ------------------------------------------------ |
| `cardNumber`   | `1111-1111-1111-1111` | 카드번호는 1111-1111-1111-1111 형식이어야 합니다 |
| `birthDate`    | 숫자 8자리            | 생년월일은 YYYYMMDD 형식(8자리)이어야 합니다     |
| `expiry`       | MMYY (01-12 + 2자리)  | 유효기간은 MMYY 형식(4자리)이어야 합니다         |
| `cardPassword` | 2자리                 | 카드 비밀번호는 앞 2자리만 입력해주세요          |
...
```json
{
  ...
  "message": "pgCardData.cardNumber: 카드번호는 1111-1111-1111-1111 형식이어야 합니다",
